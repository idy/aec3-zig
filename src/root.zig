...
test {
    ...
    _ = @import("audio_processing/sparse_fir_filter.zig");
    _ = @import("audio_processing/sinc_resampler.zig");
    _ = @import("audio_processing/push_sinc_resampler.zig");
    _ = @import("audio_processing/cascaded_biquad_filter.zig");
    _ = @import("audio_processing/high_pass_filter.zig");
    _ = @import("audio_processing/three_band_filter_bank.zig");
    _ = @import("audio_processing/splitting_filter.zig");
    _ = @import("audio_processing/audio_buffer.zig");
