...
pub const Aec3Fft = struct {
    ...
    pub fn ifft(self: *const Self, X: fft_data.FftData) [common.FFT_LENGTH]f32 {
    ...
    pub fn fftFixedQ15(self: *const Self, input: *const [common.FFT_LENGTH]@import("../../numeric_profile.zig").profileFor(.fixed_mcu_q15).Sample) fft_data.FftDataFixed {
        return self.fixed_impl.fftFixedQ15(input);
    }

    pub fn ifftFixedQ15(self: *const Self, spec_data: *const fft_data.FftDataFixed) [common.FFT_LENGTH]@import("../../numeric_profile.zig").profileFor(.fixed_mcu_q15).Sample {
