...
pub const FixedI16Pipeline = struct {
    ...
    pub fn analyze_render_i16(self: *Self, input: *const [common.FFT_LENGTH]i16, gain_q15: Q15) [common.FFT_LENGTH]i16 {
        return self.process_capture_i16(input, gain_q15);
    }
