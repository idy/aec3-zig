...
const spectrum_buffer_mod = @import("spectrum_buffer.zig");
const apm = @import("../../audio_processing/logging/apm_data_dumper.zig");

const FFT_LENGTH_BY_2_PLUS_1 = common.FFT_LENGTH_BY_2_PLUS_1;
const NUM_BLOCKS_PER_SECOND = common.NUM_BLOCKS_PER_SECOND;
const SpectrumBuffer = spectrum_buffer_mod.SpectrumBuffer;
